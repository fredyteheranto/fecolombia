...
WSDL.prototype.objectToDocumentXML = function (name, params, nsPrefix, nsURI, type) {
  console.log('<<<<<<', name, params, nsPrefix, nsURI, type)
  console.log('params', nsURI, type)
  ...
  if (Array.isArray(obj)) {
    ...
    for (name in obj) {
      ...
      if (isFirst) {
        ...
        value = self.objectToXML(child, null, nsPrefix, nsURI, false, null, schemaObject, nsContext);
      ...
      if (!Array.isArray(child) && nonSubNameSpace != '') {
        // start tag
